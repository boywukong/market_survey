...
/*
 * Fragmenta0201主要完成下面几件事：
 * 1.加载问卷3的布局和内容
 * 2.问卷3的页面内容：biao_01.html
 * 3.问卷3的按钮点击事件
 * 4.问卷3打印模板wenjuan_03_
 *
 **/
public class Fragmenta0201 extends Fragment {

    private String topic;
    private WebView mWebView;
    private String lastDocName;

    public Fragmenta0201() {
        // Required empty public constructor
        super();
    }

    public Fragmenta0201(String topic) {
        super();
        this.topic = topic;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup     container,
        ...
        Log.i("----Fragmenta0201----","file:///android_asset/html/biao_01.html");
    ...
    private class PayJavaScriptInterface {
        ...
        public void inquireData(String gsonStr) throws IOException {
            ...
            String templateName = "template/" + ActivityUtil.WENJUAN_03_PREFIX + ".docx";

            String targetUrl = Environment.getExternalStorageDirectory().toString()
                    + File.separator
                    + ActivityUtil.INQUIRE_DIR
                    + File.separator
                    + ActivityUtil.WENJUAN_03_PREFIX
